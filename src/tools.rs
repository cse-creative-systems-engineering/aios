...
mod tests {
    ...
    fn composed_instruction_contains_every_domain_claim() {
        ...
        assert_eq!(text.len(), 4534, "instruction drifted from verified length");
    }
}
