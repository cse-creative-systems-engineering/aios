...
- The current widget payload is a temporary compiled `StatusList` of specialist evidence. It must still be replaced/extended with model-selected validated widget composition before M8 is considered complete.
